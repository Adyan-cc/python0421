...
def main():
    ...
    background = pygame.image.load("tank_img/asd.png")  # 加载背景图片
    whiteStorn = pygame.image.load("tank_img/blast4.gif")  # 加载白棋图片
    blackStorn = pygame.image.load("tank_img/blast4.gif")  # 加载黑棋图片
    resultStorn = pygame.image.load("tank_img/ewq.png")  # 加载 赢 时的图片
